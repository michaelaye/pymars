...
def main():
    ...
    toDelete = []
    for ccd in range(10):
        fileBase = idString + '_' + colour + str(ccd) + '.norm.cal.cub'
        newFileName = idString + '_' + colour + str(ccd) + '.map.norm.cal.cub'
        ...
        isisCMD.append('map='+os.environ['HOME']+'/polar_map_projection.map ')
        isisCMD.append('pixres=MAP')
