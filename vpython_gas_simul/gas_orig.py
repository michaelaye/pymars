...
# added more comments
# can't stand the capital E in 6E23, replaced by 6e23 and wherever it appeared
...
# Typical values
L = 1.0 # container is a cube L on a side
gray = (0.7,0.7,0.7) # color of edges of container
# 44u is divided by 1000, because the unit is 44 g / mol, we need kg
Matom = 44e-3/6e23 # CO2 mass, 44 u (=g/mol)
Ratom = 0.03 # wildly exaggerated size of helium atom
Rhodust = 3e-15 # 3000 kg/m**3
Rdust = 1e-3 # 1 mm
Vdust = 4/3*pi*Rdust**3
Mdust = Rhodust * Vdust
print(Mdust/Matom)
...
for i in range(Natoms):
    ...
    Atoms = Atoms+[sphere(pos=(x,y,z), radius=r, color=color.green)]
    mass = Matom
